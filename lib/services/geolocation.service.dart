...
class GeolocationService {
  ...
  static Future<String?> getReverseGeocode(Position currentPosition) async {
    ...
    return '${geoPosition.first.locality == null || geoPosition.first.locality == '' ? geoPosition.first.subAdministrativeArea : geoPosition.first.locality}, ${geoPosition.first.administrativeArea}';
  }
}
